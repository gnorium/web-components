    ...
    public func render() -> Node {
      ...
      .class(
        `class`.isEmpty
          ? (showThumbnail
            ? (autoExpandWidth
              ? "typeahead-search-view typeahead-search-show-thumbnail typeahead-search-auto-expand-width"
              : "typeahead-search-view typeahead-search-show-thumbnail") : "typeahead-search-view")
          : (showThumbnail
            ? (autoExpandWidth
              ? "typeahead-search-view typeahead-search-show-thumbnail typeahead-search-auto-expand-width \(`class`)"
              : "typeahead-search-view typeahead-search-show-thumbnail \(`class`)")
            : "typeahead-search-view \(`class`)")
      )
  ...
  private class TypeaheadSearchInstance: @unchecked Sendable {
    ...
    private func bindEvents() {
      if let input = inputElement {
        _ = input.addEventListener(.input) { [self] (_: Event) in
          self.handleInput()
        }
      }
      ...
      if let view = inputViewElement {
        ...
        _ = view.addEventListener("submit-click") { [self] (_: Event) in
          self.handleSubmit()
        }
      ...
      _ = typeaheadSearchElement.addEventListener("typeahead-menu-updated") { [self] (_: Event) in
