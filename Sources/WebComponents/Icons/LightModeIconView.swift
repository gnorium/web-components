    ...
    public func build() -> DOM.Node {
      svg {
        ...
        g {
          ...
          path()
            .d(
              M(8.00043, 11.7782), C(10.0868, 11.7782, 11.7782, 10.0868, 11.7782, 8.00043),
              C(11.7782, 5.91402, 10.0868, 4.22266, 8.00043, 4.22266),
              C(5.91402, 4.22266, 4.22266, 5.91402, 4.22266, 8.00043),
              C(4.22266, 10.0868, 5.91402, 11.7782, 8.00043, 11.7782), Z()
            )
            .strokeWidth(strokeWidth)
            .strokeLinecap(.round)
            .strokeLinejoin(.round)
